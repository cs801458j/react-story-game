...
export const stageOneStory = [
  {
    ...
    contents: [
      ...
      { 
        character: "스탭",
        sentence: "안그래도 오늘 미선누님이 몸이 안 좋아서 MC 대타가 급하게 필요했는데 너가 하면 되겠다"
      },
      { 
        character: "진람쥐",
        sentence: "??? 저 지금 다람쥔데요???"
  ...
  },
  {
    ...
    contents: [
      ...
      { 
        character: "진람쥐",
        sentence: "녜 누나 ... 저 어떡하죠 자고 일어나보니 다람쥐가 됐어요ㅠㅠ 이런 몸으로 방송을 할 수 있을까요? ㅠㅠ"
      },
      { 
        character: "소현누나",
      ...
      { 
        character: "소현누나",
        sentence: "다람쥐인 지금도 충분히 귀엽고 사랑스러운걸! 오늘 찾아온김에 같이 게스트로 이야기 하다갈래?"
      },
      { 
        character: "진람쥐",
      ...
      { 
        character: "",
        sentence: "다람쥐로 변해도 즐겁고 유쾌한 진람쥐의 토크는 107.7mHz과 고릴라를 통해 전국으로 퍼져갔다."
      },
      { 
        character: "",
      ...
      { 
        character: "소현누나",
        sentence: "너는 다람쥐인 모습으로도 용기있게 라디오에 출연했기 때문에 이 버섯을 받을 자격이 있어. "
      },
      { 
        character: "획득",
